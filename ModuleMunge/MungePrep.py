...
class Munging(Resource):
    def __init__(self, filePathInp:str):
        ...
        cmd_line="/ifs/loni/faculty/njahansh/nerds/ankush/software/Anaconda/envs/ldsc/bin/python2.7 /ifs/loni/faculty/njahansh/nerds/ankush/webApplication_Genome/Git_Genome/GenomeAPI/ldsc/munge_sumstats.py --sumstats "+ self.filepath +" --out dbAccess/"+self.fileName+" --merge-alleles /ifs/loni/faculty/njahansh/nerds/ravi/genetics/ldsc/eur_w_ld_chr/w_hm3.snplist --snp ID --a1 ALLELE1 --a2 ALLELE0 --chunksize 500000"
